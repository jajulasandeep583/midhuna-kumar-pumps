...
from kumar_service.hd.api.agent_home.utils import calculate_percentage_change
from kumar_service.hd.api.analytics_utils import _apply_scope, get_avg_time_metric
from kumar_service.hd.utils import agent_only
...
def get_ticket_stats(
    ...
    stats["avg_resolution_time"] = get_avg_time_metric(
