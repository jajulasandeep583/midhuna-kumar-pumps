...
from kumar_service.helpdesk.doctype.hd_settings.helpers import (
    get_default_email_content,
    is_email_content_empty,
)
from kumar_service.helpdesk.doctype.hd_ticket_activity.hd_ticket_activity import (
    log_ticket_activity,
)
from kumar_service.helpdesk.utils.email import (
...
class HDTicket(Document):
    ...
    def tag_first_ticket(self):
        ...
        """
        from kumar_service.hd.api.tags import FIRST_TICKET_TAG, FIRST_TICKET_TAG_COLOR
    ...
    def add_tag(self, tag: str, color: str = "Gray"):
        ...
        is not applied.
        """
        from kumar_service.hd.api.tags import apply_tag
