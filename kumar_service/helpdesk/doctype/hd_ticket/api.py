...
from kumar_service.hd.api.doc import handle_at_me_support
from kumar_service.hd.consts import DEFAULT_TICKET_TEMPLATE
from kumar_service.helpdesk.doctype.hd_form_script.hd_form_script import get_form_script
from kumar_service.helpdesk.doctype.hd_settings.helpers import get_rendered_banner_msg
from kumar_service.helpdesk.doctype.hd_ticket_template.api import get_fields_meta
from kumar_service.helpdesk.doctype.hd_ticket_template.api import get_one as get_template
from kumar_service.hd.utils import (
    agent_only,
    check_permissions,
    get_customers,
    is_agent,
