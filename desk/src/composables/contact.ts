...
export function useContact(name: string) {
  ...
  async function handleDelete({
    ...
    try {
      await call("kumar_service.hd.api.contact.delete_contact", {
        name,
  ...
  function findContact(): ContactBundle {
    ...
    const bundle: ContactBundle = {
      ...
      info: createResource({
        url: "kumar_service.hd.api.contact.get_contact_info",
        method: "GET",
        params: { name },
        auto: true,
      }),
  ...
  const editContactResource = createResource({
    url: "kumar_service.hd.api.contact.edit_contact",
    method: "POST",
...
export function useNewContact() {
  ...
  const addContactResource = createResource({
    url: "kumar_service.hd.api.contact.create_contact",
    method: "POST",
...
export function useContactFeedback(name: string): ContactFeedback {
  ...
  const chartData = createResource({
    url: "kumar_service.hd.api.ticket_stats.get_feedback_received",
    makeParams: () => ({
      scope: "contact",
      value: name,
    }),
