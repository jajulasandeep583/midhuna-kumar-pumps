...
export const deleteArticles = createResource({
  url: "kumar_service.hd.api.knowledge_base.delete_articles",
  makeParams({ articles }) {
    return {
      articles,
    };
...
export const newCategory = createResource({
  url: "kumar_service.hd.api.knowledge_base.create_category",
  makeParams({ title }) {
    return {
      title,
    };
...
export const moveToCategory = createResource({
  url: "kumar_service.hd.api.knowledge_base.move_to_category",
...
export const mergeCategory = createResource({
  url: "kumar_service.hd.api.knowledge_base.merge_category",
...
export const categories = createResource({
  url: "kumar_service.hd.api.knowledge_base.get_categories",
  cache: ["categories"],
});

export const categoryName = createResource({
  url: "kumar_service.hd.api.knowledge_base.get_category_title",
  cache: ["categoryName"],
  makeParams({ category }) {
    return { category };
  },
...
export const incrementView = createResource({
  url: "kumar_service.hd.api.knowledge_base.increment_views",
  makeParams: ({ article }) => ({
    article,
  }),
});
