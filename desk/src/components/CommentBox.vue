...
const fetchReactions = createResource({
  url: "kumar_service.helpdesk.doctype.hd_ticket_comment.hd_ticket_comment.get_reactions",
...
const toggleReaction = createResource({
  url: "kumar_service.helpdesk.doctype.hd_ticket_comment.hd_ticket_comment.toggle_reaction",
