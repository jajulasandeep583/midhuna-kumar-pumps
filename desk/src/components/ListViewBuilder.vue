...
const list = createResource({
  url: "kumar_service.hd.api.doc.get_list_data",
...
const filterableFields = createResource({
  url: "kumar_service.hd.api.doc.get_filterable_fields",
...
const sortableFields = createResource({
  url: "kumar_service.hd.api.doc.sort_options",
  auto: !options.value.hideViewControls,
  params: {
    doctype: options.value.doctype,
    show_customer_portal_fields: defaultParams.show_customer_portal_fields,
...
const quickFilters = createResource({
  url: "kumar_service.hd.api.doc.get_quick_filters",
  auto: !options.value.hideViewControls,
  params: {
    doctype: options.value.doctype,
    show_customer_portal_fields: defaultParams.show_customer_portal_fields,
