    ...
    >
      ...
      >
        ...
        <BarChartCard
          ...
          :data="chartData"
          api-url="kumar_service.hd.api.ticket_stats.get_sla_violations"
          :dt="props.dt"
          :dn="props.dn"
          orientation="horizontal"
          bar-color="#E03636"
        ...
        <LineChartCard
          ...
          api-url="kumar_service.hd.api.ticket_stats.get_avg_first_response_time"
          :dt="props.dt"
          :dn="props.dn"
          orientation="horizontal"
        />
        <LineChartCard
          ...
          api-url="kumar_service.hd.api.ticket_stats.get_avg_resolution_time"
          :dt="props.dt"
          :dn="props.dn"
          orientation="horizontal"
        />
...
const analytics = createResource({
  url: "kumar_service.hd.api.ticket_stats.get_ticket_stats",
  method: "GET",
  makeParams: () => ({
    dt: props.dt,
    dn: props.dn,
