...
const createUpdateFieldDependency = createResource({
  url: "kumar_service.hd.api.settings.field_dependency.create_update_field_dependency",
  auto: false,
  makeParams: () => ({
...
const fieldDependency = createResource({
  url: "kumar_service.hd.api.settings.field_dependency.get_field_dependency",
  params: {
